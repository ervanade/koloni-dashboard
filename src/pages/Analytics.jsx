...
const Analytics = () => {
  return (
    ...
    <div>
        ...
        <h1 className='text-textBold font-bold text-2xl mb-1'>Brand Analytics</h1>
        <p className='font-thin text-textThin'>Brand Analytics the right creators for your campaigns</p>
    </div>
    <div className='bg-[#efeff1] text-blue-500 rounded-full px-4 py-2 shadow-sm'>
      ...
      <h1 className='font-normal text-lg mb-4'>Brand Analytics</h1>
